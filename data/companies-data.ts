export const CompaniesData = [
  {
    ...
    about: 'ACACO is a custom software development and consulting company focusing on web and mobile software development. In this company, many projects have been done in different fields, most of which have been done by the following two main systems, and I have participated in them.',
    projects: [
      {
        id: 7011,
        title: 'UCMS',
        alt: 'UCMS Logo',
        description: 'UCMS is a professional CMS for universities and educational institutions that includes necessary features for the activities and programs of a reputable center.',
      ...
      },
      {
        ...
        title: 'Epage',
        alt: 'Epage Logo',
        description: 'ePage is an online site content management service. You can build and manage a completely dynamic dynamic website without having to specialize in web design. ePage is suitable for small personal businesses that do not have high technical knowledge',
        logo: '/assets/images/projects/epage.png',
      }
    ],
    challenges: {
      intro: 'During my career at ACA, I faced many different challenges and issues that resulted in learning new technologies and expanding my technical knowledge. Some of these challenges were:',
      data: [
        {
          id: 'ch-aca-1',
